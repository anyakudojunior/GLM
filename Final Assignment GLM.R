...
# 3. Comparing Link Functions using AIC:
...
# 5. Using the Hosmer-Lemeshow Test for Non-Repeated Observations:
...
# 6. Residuals:
# Even though the likelihood-ratio tests suggest that the Stroop predictors are not
# statistically significant, residual diagnostics are still performed on the full models.
# This is done to assess whether the Binomial GLM assumptions and chosen link functions
